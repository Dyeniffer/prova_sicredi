...
public void setUp() throws Exception {
    ...
    baseUrl = "https://www.grocerycrud.com/demo/bootstrap_theme";
    driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
}

// Preencher os campos do formulário e salvar
@Test
public void testUntitledTestCase() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='from Employeer'])[1]/following::span[1]")).click();
